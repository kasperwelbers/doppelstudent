...
usethis::use_package( "corpustools" ) # To call each time you need a new package
...
usethis::use_package( "shinyalert" ) # To call each time you need a new package
...
## 3.1 Vignette
usethis::use_vignette("doppelstudent")
