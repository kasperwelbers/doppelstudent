...
golem::fill_desc(
  pkg_name = "doppelstudent", # The Name of the package containing the App 
  pkg_title = "Shiny app for open ended question similarity", # The Title of the package containing the App 
  pkg_description = "A shiny app that scores and visualizes the similarity of answers to open-ended exam questions. Designed for testvision output.", # The Description of the package containing the App 
...
usethis::use_mit_license( name = "Kasper Welbers" )  # You can set another licence here
